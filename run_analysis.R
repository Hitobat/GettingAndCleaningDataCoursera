# Course project for the "Data Science - Getting and Cleaning Data" course on Coursera. 
...
# --- STEP 4 ---
# Label data set with describe variable names (already done) and add subject ids.
